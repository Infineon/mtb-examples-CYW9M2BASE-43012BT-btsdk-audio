...
- btspeaker:<br/>
    - A Bluetooth Speaker reference app demonstrating Bluetooth A2DP sink, AVRCP Controller/Target and Handsfree profiles.
- audio_gateway:<br/>
    - Sample app demonstrating Bluetooth Audio Gatway profile
- audio_sink:<br/>
    - Sample app demonstrating Bluetooth A2DP Sink profile
- handsfree:<br/>
    - Sample app demonstrating Bluetooth Handsfree profile
- headset:<br/>
    - Sample app demonstrating Bluetooth Headset profile
